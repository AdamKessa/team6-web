                ...
                <div class="imagehover2 row mt-5">
                  ...
                  <div class="overlay">
                    ...
                    <div class="modal-footer  bg-white text-dark justify-content-center">
                      <button type="button" class="btn btn-default justify-content-center" data-dismiss="modal"><p style="color: rgb(255, 115, 0); font-size: 20px;"><a href="Bookatable.php">order now</a></p></button>
                    </div>
                  </div>
                </div>
