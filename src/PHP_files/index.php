...
<head>
    ...
    <link rel="icon" href="https://png.pngtree.com/png-vector/20220623/ourmid/pngtree-food-logo-png-image_5297921.png">
    <link rel="stylesheet" href="../layout/CSS_files/home.css">
        ...
        <div class="Home-page">
            ...
            <div class="cont">
                ...
                <div class="mid">
                    ...
                    <ul>
                        <li class="name2"
                            style="font-family: 'Dancing Script', cursive; font-size: 66px; color: rgb(245, 86, 6);">
                            Welcome</li>

                        <li style="font-size:40PX ;"> RESTAURANT</li>
                        <li style="font-size:18PX ; font-weight: normal;"> <span class="vert">__________</span> NEW
                            FLAVOURS
            ...
            <div class="MIDLE">
                <article>
                    ...
                    <div class="pic-ctn">
                        <p class="FFF">
                            Uzbek cuisine is hearty, rich and delicious. Developed to feed an agrarian society, many of
                            its dishes are packed full of calories once needed to sustain workers in the fields. Recipes
                            are heavy on meat, relying primarily on the fatty sheep that graze in the country's
                            pastureland.
                        </p>


                        <img src="https://attuale.ru/wp-content/uploads/2018/02/7fb0ba22ade79be35017e8a0f07fb089.jpg"
                            alt="" class="pic">
                        ...
                        <img src="https://bystryerecepty.ru/wp-content/uploads/2022/06/blobid1530258764605.jpg" alt=""
                            class="pic">
                        <img src="../layout/images/sumalyak.jpg" alt="" class="pic">
